...
exports.intFilter = exports.float = exports.wordcount = exports.urlize = exports.urlencode = exports.upper = exports.truncate = exports.trim = exports.title = exports.striptags = exports.string = exports.sort = exports.sum = exports.slice = exports.round = exports.reverse = exports.replace = exports.selectattr = exports.select = exports.rejectattr = exports.reject = exports.getSelectOrReject = exports.random = exports.nl2br = exports.lower = exports.list = exports.length = exports.last = exports.join = exports.indent = exports.groupby = exports.forceescape = exports.first = exports.safe = exports.escape = exports.dump = exports.dictsort = exports.default_ = exports.center = exports.capitalize = exports.batch = exports.isNaN = exports.abs = exports.normalize = void 0;
const lib = __importStar(require("./lib"));
const r = __importStar(require("./runtime"));
...
function dictsort(val, caseSensitive, by) {
    if (!lib.isObject(val)) {
        throw new templateError_1.TemplateError('dictsort filter: val must be an object');
    }
    let array = [];
    ...
    if (by === undefined || by === 'key') {
        ...
        throw new templateError_1.TemplateError('dictsort filter: You can only sort by either key or value');
    }
    array.sort((t1, t2) => {
        let a = t1[si];
        let b = t2[si];
...
exports.dump = dump;
function escape(str) {
    if (str instanceof SafeString_1.SafeString) {
        return str;
    }
...
function length(val) {
    ...
    else if (value instanceof SafeString_1.SafeString) {
        return value.length;
    }
    else if (lib.isObject(value) && !(value instanceof SafeString_1.SafeString)) {
...
function list(val) {
    if (lib.isString(val)) {
        ...
        throw new templateError_1.TemplateError('list filter: type not iterable');
    }
}
exports.list = list;
function lower(str) {
...
exports.getSelectOrReject = getSelectOrReject;
...
function replace(str, old, new_, maxCount) {
    ...
    if (typeof str !== 'string' && !(str instanceof SafeString_1.SafeString)) {
        return str;
    }
    // ShortCircuits
    if (old === '') {
...
exports.sort = r.makeMacro(['value', 'reverse', 'case_sensitive', 'attribute'], [], function sortFilter(arr, reversed, caseSens, attr) {
    ...
    array.sort((a, b) => {
        ...
        if (this.env.opts.throwOnUndefined &&
...
exports.float = float;
exports.intFilter = r.makeMacro(['value', 'default', 'base'], [], function doInt(value, defaultValue, base = 10) {
...
module.exports = Object.assign(Object.assign({}, module.exports), { 'int': exports.intFilter });
