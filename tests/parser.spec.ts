...
//  let NunjucksNodeList;
  ...
  if (typeof require !== 'undefined') {
    ...
    Or = require('../nunjucks/src/compiler/lexer/operators/or').Or;
    Import = require('../nunjucks/src/nodes/import').Import;
    In = require('../nunjucks/src/compiler/lexer/operators/in').In;
    Macro = require('../nunjucks/src/nodes/macro').Macro;
    Is = require('../nunjucks/src/compiler/lexer/operators/is').Is;
    Case = require('../nunjucks/src/nodes/case').Case;
    Concat = require('../nunjucks/src/compiler/lexer/operators/concat').Concat;
    ...
    Not = require('../nunjucks/src/compiler/lexer/operators/not').Not;
    ...
    And = require('../nunjucks/src/compiler/lexer/operators/and').And;
    KeywordArgs = require('../nunjucks/src/nodes/keywordArgs').KeywordArgs;
    If = require('../nunjucks/src/nodes/if').If;
    parser = require('../nunjucks/src/compiler/parser/parser');
